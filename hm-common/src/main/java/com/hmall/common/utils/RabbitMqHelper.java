...
public class RabbitMqHelper {
    ...
    public void sendMessage(String exchange, String routingKey, Object msg){
        log.debug("发送普通消息，exchange:{}, routingKey:{}, msg:{}", exchange, routingKey, msg);
        rabbitTemplate.convertAndSend(exchange, routingKey, msg);
    }

    public void sendDelayMessage(String exchange, String routingKey, Object msg, int delay){
        log.debug("发送延迟消息，exchange:{}, routingKey:{}, msg:{}, delay:{}", exchange, routingKey, msg, delay);
    ...
    public void sendMessageWithConfirm(String exchange, String routingKey, Object msg, int maxRetries){
        log.debug("发送带确认消息，exchange:{}, routingKey:{}, msg:{}", exchange, routingKey, msg);
